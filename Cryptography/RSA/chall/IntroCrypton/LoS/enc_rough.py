...
hash_p = hashlib.sha256(str(p).encode('ascii')).hexdigest()
hash_q = hashlib.sha256(str(q).encode('ascii')).hexdigest()
...
for i in range(2):
	p1 = input("Give me p: ").encode('ascii')
	p2 = input("Give me q: ").encode('ascii')
